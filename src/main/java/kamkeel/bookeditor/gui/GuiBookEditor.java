...
public class GuiBookEditor extends GuiScreen {
    ...
    // Button declarations using constants
    ...
    public void initGui() {
        ...
        if (this.heldBookIsWritable) {
            ...
            this.buttonList.add(new GuiButton(Buttons.BTN_DONE, 5, 115, buttonWidth, buttonHeight, "Done"));
            this.buttonList.add(new GuiButton(Buttons.BTN_COPY_ALL_TEXT, 5, 140, buttonWidth, buttonHeight, "Copy All Text"));
            ...
            this.buttonList.add(new GuiButton(Buttons.BTN_ADD_SIGNATURE_PAGES, 5, 60, buttonWidth, buttonHeight, "Add Signature Pages"));
        ...
        switch (buttonPressed.id) {
            ...
            case Buttons.BTN_CUT_MULTIPLE_PAGES:
                if (this.selectedPageA != -1 && this.selectedPageB != -1 && this.selectedPageA >= 0 && this.selectedPageA <= this.selectedPageB && this.selectedPageB < this.book.pages.size()) {
                    ...
                    this.pageClipboard.clear();
                    this.pageClipboard = this.book.cutPages(this.book.cursorPage, this.book.cursorPage);
                }
                return;
            case Buttons.BTN_ADD_SIGNATURE_PAGES:
                ...
                return;
            case Buttons.BTN_COPY_ALL_TEXT:
    ...
    protected void mouseClicked(int posX, int posY, int button) {
        ...
        if (this.heldBookIsWritable && posX >= bookTextLeft && posX < bookTextLeft + 116 && posY >= bookTextTop && posY < bookTextTop + 116) {
            ...
            BookCursorHelper.placeCursorFromClick(this.book, rowGuess, xOffset);
        }
