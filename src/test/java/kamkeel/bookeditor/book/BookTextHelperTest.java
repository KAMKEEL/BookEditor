...
public class BookTextHelperTest {
    ...
    @Test
    public void addTextAtCursorSingleNewlineMovesCursorToNextLine() {
        Book book = createBook(createPage(""));
        ...
        assertThat(book.pages.get(0).lines.size(), is(2));
    }

    @Test
    public void addTextAtCursorDoubleNewlinePlacesCursorOnSubsequentBlankLine() {
        Book book = createBook(createPage(""));
