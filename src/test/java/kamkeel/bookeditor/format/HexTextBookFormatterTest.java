...
public class HexTextBookFormatterTest {
    ...
    @Test
    public void detectFormattingCodeLengthHandlesAmpersandStyles() {
        assertThat(formatter.detectFormattingCodeLength("&lBold", 0), is(2));
        assertThat(formatter.detectFormattingCodeLength("&oItalic", 0), is(2));
    }
    ...
    @Test
    public void getFormatFromStringRecognisesAmpersandStyles() {
        assertThat(formatter.getFormatFromString("&lBold"), is("&l"));
    }
    ...
    public void sanitizeFormattingRemovesDanglingAmpersand() {
        assertThat(formatter.sanitizeFormatting("Text&"), is("Text"));
    }
}
